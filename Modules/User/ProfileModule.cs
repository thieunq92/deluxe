...
namespace CMS.Modules.User
{
	...
	public class ProfileModule : ModuleBase, IActionConsumer
	{
		...
		private void InitInboundActions()
		{
			...
			this._inboundActions.Add(new CMS.Core.Communication.Action("ViewProfile", new string[1] {"UserId"}));
			this._inboundActions.Add(new CMS.Core.Communication.Action("EditProfile", null));
			this._inboundActions.Add(new CMS.Core.Communication.Action("Register", null));
			this._inboundActions.Add(new CMS.Core.Communication.Action("ResetPassword", null));
		}
