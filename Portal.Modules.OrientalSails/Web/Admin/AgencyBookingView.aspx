<%@ Page Title="" Language="C#" MasterPageFile="MainAgency.Master" AutoEventWireup="true" CodeBehind="AgencyBookingView.aspx.cs" Inherits="Portal.Modules.OrientalSails.Web.Admin.AgencyBookingView" %>
...
<div class="form-group">
    <div class="row">
        <div class="col-xs-12">
            ...
            <input type="button" class="btn btn-primary" id="btnEmail" runat="server" value="Send mail" Visible="False"/>
            <input type="button" class="btn btn-primary" id="btnViewHistory" runat="server" value="View history" Visible="False"/>
        </div>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-xs-3 --no-padding-left">
            ...
            <asp:Button runat="server" ID="btnLockIncome" CssClass="btn btn-primary" Text="Lock booking" Visible="False"
