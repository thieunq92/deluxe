<%@ Page Title="Add booking" Language="C#" MasterPageFile="MainAgency.Master" AutoEventWireup="true" CodeBehind="AgencyAddBooking.aspx.cs" Inherits="Portal.Modules.OrientalSails.Web.Admin.AgencyAddBooking" %>
        ...
        <div class="col-xs-12">
            <table class="table table-borderless table-common">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDate" autocomplete="off" runat="server" CssClass="form-control" 
                    ...
                    <asp:PlaceHolder ID="plhEndDate" runat="server">
                        <td>End date*</td>
                        <td>
                            <asp:TextBox ID="txtEndDate" autocomplete="off" runat="server"></asp:TextBox><ajax:CalendarExtender ID="calenderEnd"
