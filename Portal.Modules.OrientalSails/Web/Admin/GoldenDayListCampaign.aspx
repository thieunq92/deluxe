        ...
        <div class="row">
            <div class="col-xs-6 --no-padding-leftright">
                <table class="table table-bordered table-hover table-common">
                        ...
                        <asp:Repeater runat="server" ID="rptCampaign" OnItemCommand="rptCampaign_ItemCommand" OnItemDataBound="rptCampaign_ItemDataBound">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><%# GetDateApplied((Campaign)Container.DataItem) %></td>
                    ...
                    <% if (!IsPostBack)
                       {
                           if (((System.Collections.Generic.IEnumerable<Campaign>)rptCampaign.DataSource).Count() <= 0)
                           {
                    %>
                    <tr>
                    ...
                    <ContentTemplate>
                        <asp:PlaceHolder ID="plhTableBooking" runat="server" Visible="false">
                            <table class="table table-bordered table-hover table-common">
                                ...
                                <% if (((System.Collections.Generic.IEnumerable<Booking>)rptBooking.DataSource).Count() <= 0)
                                   {
                                %>
                                <tr>
                                    <td colspan="100%">No records found </td>
