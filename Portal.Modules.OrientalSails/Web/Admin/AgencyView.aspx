...
<asp:Content ID="AdminContent" ContentPlaceHolderID="AdminContent" runat="server">
    <div class="row">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div  class="col-xs-3">
                    <h5 class="--text-bold">AGENCY USER</h5>
                            ...
                            <asp:Repeater ID="rptUsers" runat="server" OnItemCommand="rptUsers_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="lbtDelete" runat="server" CommandArgument='<%#Eval("Id") %>' CommandName="delete" Text="Remove user"></asp:LinkButton></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </table>
