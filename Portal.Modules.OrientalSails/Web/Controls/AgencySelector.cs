...
namespace Portal.Modules.OrientalSails.Web.Controls
{
    public class AgencySelector : WebControl, IPostBackDataHandler, IModuleControl, ISelectorControl
    {
        ...
        protected SailsModule _module = SailsModule.GetInstance();
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            output.AddAttribute(HtmlTextWriterAttribute.Onchange, @"$(this).parent().siblings('[data-control=send]').click()");
