...
<asp:Content ID="AdminContent" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <div class="row">
        <div class="col-xs-12">
            <a href="SalesPerformanceAnalysis.aspx?NodeId=1&SectionId=15&SalesId=<%= CurrentUser.Id %>" class="btn btn-primary">Sales performance report </a>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-5">
        ...
        <div class="col-xs-5 --no-padding-left --no-padding-right">
            <div class="row">
                <div class="col-xs-12 --no-padding-leftright">
                    <h4 class="--text-bold">Today running groups</h4>
                    <table class="table table-bordered table-common ">
                        <tbody>
                            ...
                            <asp:Repeater ID="rptTodayRunningGroups" runat="server" OnItemDataBound="rptTodayRunningGroups_ItemDataBound" OnItemCommand="rptTodayRunningGroups_OnItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><a href="javascript:void(0)" data-toggle="modal" data-target="#addNoteModal"
                                            onclick="$('#addNoteModal .modal-title').html('Add note trip code <%# GetTripCode((EventCode)Container.DataItem)%>')
                                                     ;clearFormAddNote()
                                                     ;$('#<%=hidTripCode.ClientID %>').val('<%# GetTripCode((EventCode)Container.DataItem) %>')">Add note</a>
                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#viewNoteModal" onclick="$('#viewNoteModal .modal-title').html('View note trip <%# GetTripCode((EventCode)Container.DataItem) %>' );$('#<%# Container.FindControl("btnViewNote").ClientID %>').trigger('click');">View
                                                <span class="badge"><%# NoteGetCountOfNewNotes((EventCode)Container.DataItem) %></span></a>
                                            <asp:Button runat="server" ID="btnViewNote" CommandArgument="<%# GetTripCode((EventCode)Container.DataItem) %>" CommandName="View"
                                                CssClass="hidden"></asp:Button>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="col-xs-2">
                    <h4 class="--text-bold" style="display: block; max-width: 50%">Month summary</h4>
                    <asp:DropDownList runat="server" ID="ddlMonthSearching" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlMonthSearching_SelectedIndexChanged" Style="width: auto; padding: 0; display: inline-block; position: relative; bottom: 7px">
                    </asp:DropDownList>
                    <asp:DropDownList runat="server" ID="ddlYearSearching" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlYearSearching_SelectedIndexChanged" Style="width: auto; padding: 0; display: inline-block; position: relative; bottom: 7px">
                    </asp:DropDownList>
                            ...
                            <asp:Repeater ID="rptRecentMeetings" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="--text-left">
                                            <article><%# ((Activity)Container.DataItem).Note%></article>
                                        </td>
                                        <td class="--text-right">
    ...
    <div class="modal fade modal-viewnote" id="viewNoteModal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
        <div class="modal-dialog" role="document" style="width: 500px">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h3 class="modal-title">View note </h3>
                </div>
                <div class="modal-body">
                    <asp:UpdatePanel runat="server">
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="rptTodayRunningGroups" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
            </div>
    ...
    <div class="modal fade note-modal" id="addNoteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog note-modal__modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title --text-bold" id="myModalLabel1">Add note</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-10 --no-padding-leftright">
                                <asp:TextBox runat="server" ID="txtNoteTripCode" CssClass="form-control" TextMode="MultiLine" Rows="12" placeholder="Note" Text="" data-id="txtAgencyNotesNote" />
                            </div>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Scripts" ContentPlaceHolderID="Scripts" runat="server">
    <script>
        $('.modal-selectGuide').on('shown.bs.modal',
            function() {
